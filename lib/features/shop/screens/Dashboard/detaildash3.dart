...
class Magellandash extends StatefulWidget {
  Magellandash({
    super.key,
    this.mapdoc,
  });
  ...
  @override
  State<Magellandash> createState() => _MagellandashState(mapdoc);
}

class _MagellandashState extends State<Magellandash> {
  final mapdoc;
  _MagellandashState(this.mapdoc);
